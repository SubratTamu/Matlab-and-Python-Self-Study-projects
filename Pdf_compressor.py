...
def main():
    ...
    # Run
    compress('D:\MS Documents\ 1.FINAL UNIVERSITY_TAMU\Leap loan\Loan_agreement_signed.pdf', 'D:\MS Documents\ 1.FINAL UNIVERSITY_TAMU\Leap loan\Loan_agreement_Comp_signed.pdf', power=1)
